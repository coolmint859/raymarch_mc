...
pub const NIGHT_ZENITH: Vec3 =  glam::vec3(0.0,  0.0,  0.01);

pub const DAY_HORIZON: Vec3 =   glam::vec3(0.6, 0.75, 0.95);
pub const DUSK_HORIZON: Vec3 =  glam::vec3(0.4, 0.2, 0.2);
pub const NIGHT_HORIZON: Vec3 = glam::vec3(0.0, 0.0, 0.01);
...
impl VoxelPalette {
    pub fn create() -> Self {
        let colors = vec![
            ...
            Vec4::new(0.0, 0.1, 0.0, 1.0),   // 2: Grass
            Vec4::new(0.0, 0.0, 0.1, 1.0),   // 3: Water
        ];
